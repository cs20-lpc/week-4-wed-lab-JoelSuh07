...
void DoublyList<T>::insert(int position, const T& elem) {
  ...
  if (position < 0 || position > this->length) throw string ("insert: error, position out of bounds.");
...
void DoublyList<T>::remove(int position) {
    ...
    if (position < 0 || position >= this->length) throw string ("remove: error, position out of bounds.");
...
bool DoublyList<T>::search(const T& elem) const {
    ...
    if (position < 0 || position >= this->length) throw string ("search: error, position out of bounds.");
...
void DoublyList<T>::replace(int position, const T& elem) {
    ...
    if (position < 0 || position >= this->length) throw string ("replace: error, position out of bounds.");
